...
function Module(uri, deps) {
  ...
  this.deps = {} // Ref the dependence module
  this.status = 0
...
Module.define = function (id, deps, factory) {
  ...
  // Try to derive uri in IE6-9 for anonymous module
...
Module.save = function(uri, meta) {
  ...
  // Do NOT override already saved module
...
/**
 * config.json - The configuration for the loader
 */
